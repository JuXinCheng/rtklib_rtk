...
static const char qt_meta_stringdata_optionssauvepoints[] = {
    "optionssauvepoints\0\0SaveOptions(QStringList)\0"
    "ChoixFilepath()\0Cancel()\0Save()\0"
};
...
const QMetaObjectExtraData optionssauvepoints::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject optionssauvepoints::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_optionssauvepoints,
      qt_meta_data_optionssauvepoints, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &optionssauvepoints::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_optionssauvepoints))
